...
the [RStudio](http://rstudio.org/) integrated development environment for 
...
[ISO 8601](http://en.wikipedia.org/wiki/ISO_8601) 'T' separator.  If  an 
...
Phase and Event Detection](http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.116.245&rep=rep1&type=pdf)). The `STALTA()` method has the following
